              ...
              <tbody>
                <?php
                  foreach ($medicine_data as $value) {
                    if ($value->valid == true) {
                      echo "<tr style='cursor:pointer;' onclick='window.location.href = \"/medicine/about/".$value->post_id."\";' class='text-center'><th scope='row'>".$value->post_id."<td>".$value->interval."</td><td>2021-02-28</td><td>2021-02-28</td><td class='text-success'><i class='fa fa-check-circle'></i></td>";
                    }else{
